class QueueWriteDestination extends HTMLElement {
    ...
    constructor(outputDestination) {
        ...
        this.#name = `queueWrite_${outputDestination?.name}`;
    }
...
customElements.define('queue-write-destination', QueueWriteDestination);