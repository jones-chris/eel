...
import static io.eel.flow_api_aws_lambda.stacks.Constants.RETENTION_IN_DAYS;
import static io.eel.flow_api_core.stacks.model.ResourceType.AWS_S3_BUCKET_ARN;
import static io.eel.flow_api_core.stacks.model.ResourceType.AWS_S3_BUCKET_NAME;
...
public class AwsS3LandingBucketFlowComponentStackImpl extends FlowComponentStack {
    ...
    private void provisionBucketLifeCyclePolicy(String bucketName) {
        LifecycleExpiration expiration = LifecycleExpiration.builder()
                .days(RETENTION_IN_DAYS)  // Make sure this matches the Lambda log retention policy.
                .build();
